...
function TwoColumnAds({ bannerOne, bannerTwo, bannerThree }) {
  return (
    <>
        ...
        <div className="w-full h-[460px]">
          <div className="container-x mx-auto h-full">
            ...
            >
              ...
              {bannerTwo && (
                <div
                  className="w-full rounded h-full px-[40px] py-[30px] flex justify-center"
                  style={{
                    backgroundImage: `url(${
              ...
              {bannerThree && (
                <div
                  className="w-full rounded h-full px-[40px] py-[30px] flex justify-start"
                  style={{
                    backgroundImage: `url(${
                      process.env.NEXT_PUBLIC_BASE_URL + bannerThree.image
                    })`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                  }}
                >
                  <div className="md:w-[266px] w-full h-full">
                    <div>
                      <p className="text-qblack text-sm uppercase mb-2">
                        {bannerThree.title_one}
                      </p>
                      <h2 className="md:text-[34px] text-[26px] font-semibold md:leading-[42px] mb-[40px]">
                        {bannerThree.title_two}
                      </h2>
                    </div>
                    <div>
                      <Link
                        href={{
                          pathname: "/products",
                          query: { category: bannerThree.product_slug },
                        }}
                        passHref
                      >
                        <a rel="noopener noreferrer">
                          <ShopNowBtn
                            className="w-[128px] h-[40px] bg-qblue"
                            textColor="text-white group-hover:text-white"
                          />
                        </a>
                      </Link>
